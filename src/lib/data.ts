...
export const PROFILE = {
    ...
    products: {
        extensions: [
            ...
            { name: "文档查重助手 Pro", version: "v2.0", status: "已发布", description: "教研质检利器。高效检测文档重复率，保障内容原创性。", url: "https://chromewebstore.google.com/detail/%E6%96%87%E6%A1%A3%E6%9F%A5%E9%87%8D%E5%8A%A9%E6%89%8B-pro/iicjkpmhadepfgmminjoljgbjaaobkef?authuser=0&hl=zh-CN" }
        ],
        apps: [
